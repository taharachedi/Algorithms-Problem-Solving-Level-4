...
3. **Calendar Layout**: Using Zeller's Congruence, the program calculates the weekday of the first day of each month and arranges the dates accordingly.
...
- **`Print_Month_Calendar`**: Displays a formatted monthly calendar in the console.
